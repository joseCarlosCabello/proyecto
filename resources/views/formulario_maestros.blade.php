                ...
                <form action="{{route('proyecto.Maestro_store')}}"method="POST">
                    @csrf
                        ...
                        <div class="form-group"> <!-- horario -->
                            ...
                            <input type="string" required class="form-control" id="horario" name="horario" placeholder="horario"value="{{old('horario')}}">
                        ...
                        <div class="form-group"> <!-- horas -->
                            ...
                            <input type="integer" required class="form-control" id="horas" name="horas" placeholder="horas"value="{{old('horas')}}">
                            @if ($errors->has('horario'))
                             <p>{{$errors->first('horario')}}</p>
                             @endif
                        </div>
